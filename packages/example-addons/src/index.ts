 ...
 * ---------------------------------------------------------------------------------------------
 */
export { activate as clientProcessorActivate } from "./client-processor";
export { activate as clientTransformerActivate } from "./client-transformer";
export { activate as exportYamlGeneratorActivate } from "./export-yaml-generator";
export { activate as fooAddedGeneratorActivate } from "./foo-added-generator";
export { activate as foobarExportProcessorActivate } from "./foobar-export-processor";
